...
(function ($, anim) {
  ...
  var Sidenav = /*#__PURE__*/function (_Component) {
    ...
    function Sidenav(el, options) {
      ...
      _this3 = _super.call(this, Sidenav, el, options);
      _this3.el.M_Sidenav = _assertThisInitialized(_this3);
      ...
      _this3.isDragged = false; // Window size variables for window resize checks
      ...
      Sidenav._sidenavs.push(_assertThisInitialized(_this3));
